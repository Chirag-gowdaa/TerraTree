...
BOTANY_CATALOG: Dict[str, Dict[str, Any]] = {
    "combretaceae": {
        ...
        "leaf_morphology": "Simple, alternate or sub-opposite, elliptic-oblong with prominent lateral veins extending to margin; distinct foliar glands at the petiole apex.",
        "bark_stem_anatomy": "Distinctive deeply fissured tessellated bark resembling 'crocodile skin'; thick outer rhytidome providing extreme fire resilience and drought protection.",
        "ecological_keystone_role": "Dominant upper canopy emergent in Western Ghats moist deciduous forests; prime carbon storehouse, nesting site for Great Indian Hornbill, and heavy mast fruit source.",
    ...
    "fabaceae": {
        ...
        "ecological_keystone_role": "Primary biogeochemical regenerator; symbiotic Bradyrhizobium root nodules fix atmospheric nitrogen directly into impoverished Western Ghats lateritic soils.",
    ...
    "mangrove": {
        ...
        "ecological_keystone_role": "World's most critical 'Blue Carbon' sink, sequestering up to 4-10x more carbon per hectare than terrestrial forests; acts as an indispensable biophysical storm barrier dampening cyclonic tidal surges for over 10 million coastal inhabitants.",
        "ethnobotany_timber": "Sundari tree timber (Heritiera fomes) yields dense, rot-proof hardwood used in boatbuilding; mangrove flowers sustain the wild Sunderban honey economy.",
        "conservation_status": "UNESCO World Heritage Site & Ramsar Wetland of International Importance; Heritiera fomes classified as Endangered (IUCN).",
...
def get_botanical_profile(class_or_family_name: str) -> Dict[str, Any]:
    """Retrieve structured botanical diagnostic information for a given plant family or land-cover class."""
    clean_key = str(class_or_family_name).strip().lower()
    
    if clean_key in BOTANY_CATALOG:
        return BOTANY_CATALOG[clean_key]
        
    for key, data in BOTANY_CATALOG.items():
